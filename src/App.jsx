...
function App() {
  ...
  return (
    ...
    <h1 className='m-5 text-center text-2xl text-gray-800'>A Simple Calculator</h1>
      <div className={`drop-shadow-xl/25 h-[80vh] w-[60vw] mx-auto rounded-4xl pt-5 ${light ? 'bg-gray-700' : 'bg-white'}`}>
        <div className={`w-[15vw] h-[5vh] rounded-2xl z-20 mx-auto relative ${light ? 'bg-gray-600' : 'bg-white'}`}>
        ...
        <div className={`text-right mt-12 pl-10 pr-10 pb-3 min-h-[15vh] ${light ? 'text-white' : 'text-black'}`}>
        ...
        <div className={`h-[50vh] w-full rounded-4xl p-3 ${light ? 'bg-gray-600' : 'bg-white'}`}>
          <div>
            <div className='flex justify-center items-center h-[9vh] gap-3'>
              <button onClick={() => handleClear()} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handlePlusMinus()} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
                <span className='text-cyan-400 text-base font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                  <FaPlusMinus />
                </span>
              </button>
              <button onClick={() => handlePercent()} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
                <span className='text-cyan-400 text-base font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                  <FaPercent />
                </span>
              </button>
              <button onClick={() => handleOperation(iconValue.FaDivide)} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
            ...
            <div className='flex justify-center items-center h-[9vh] gap-3'>
              <button onClick={() => handleNumber('7')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleNumber('8')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleNumber('9')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleOperation(iconValue.FaXmark)} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
                <span className='text-red-400 text-base font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                  <FaXmark />
                </span>
              </button>
            ...
            <div className='flex justify-center items-center h-[9vh] gap-3'>
              <button onClick={() => handleNumber('4')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleNumber('5')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleNumber('6')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleOperation(iconValue.FaMinus)} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
                <span className='text-red-400 text-base font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                  <FaMinus />
                </span>
              </button>
            ...
            <div className='flex justify-center items-center h-[9vh] gap-3'>
              <button onClick={() => handleNumber('1')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleNumber('2')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleNumber('3')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleOperation(iconValue.FaPlus)} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
                <span className='text-red-400 text-base font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                  <FaPlus />
                </span>
              </button>
            ...
            <div className='flex justify-center items-center h-[9vh] gap-3'>
              <button onClick={() => handleDelete()} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleNumber('0')} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <button onClick={() => handleDot()} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
                <span className={`text-base font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ${light ? 'text-white' : 'text-black'}`}>
                  .
                </span>
              </button>
              <button onClick={() => handleEquals()} className={`h-[7vh] w-[10vw] rounded-xl relative ${light ? 'bg-gray-700' : 'bg-white'}`}>
                <span className='text-red-400 text-base font-bold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
                  <FaEquals />
                </span>
              </button>
